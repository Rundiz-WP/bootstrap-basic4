<div class="wrap">
    ...
    <p>
        <?php 
        /* translators: %1$s: Open link, %2$s: Close link */
        printf(__('You can see what was changed in each version or each commits on our %1$sGitHub page%2$s.', 'bootstrap-basic4'), '<a href="https://github.com/Rundiz-WP/bootstrap-basic4" target="bb4_commits">', '</a>'); 
        ?> 
