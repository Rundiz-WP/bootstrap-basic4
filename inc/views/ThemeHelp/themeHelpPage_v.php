<div class="wrap">
    <h2>Bootstrap Basic4 help</h2>

    <h3>Menu</h3>
    <p>To display menu correctly, please create at least 1 menu and set as primary and save.</p>

    <h3>Bootstrap features</h3>
        <p>This theme can use all Bootstrap 4 classes, elements and styles. Please read the <a href="http://v4-alpha.getbootstrap.com/getting-started/introduction/" target="bootstrap4_doc">Bootstrap 4 document</a>.</p>

    <h3>Responsive image</h3>
    <p>For responsive image please add img-fluid class to img element. Example: <code>&lt;img src=&quot;...&quot; alt=&quot;&quot; class=&quot;img-fluid&quot;&gt;</code></p>
