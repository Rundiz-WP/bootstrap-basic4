<div class="wrap">
    ...
    <p>
        <?php echo sprintf(__('You can see what was changed in each version or each commits on our %sGithub page%s.', 'bootstrap-basic4'), '<a href="https://github.com/Rundiz-WP/bootstrap-basic4" target="bb4_commits">', '</a>'); ?> 
