...
if (!class_exists('\\BootstrapBasic4\\BootstrapBasic4')) {
    ...
    class BootstrapBasic4
    {
        ...
        {
            wp_enqueue_style('bootstrap-basic4-wp-main', get_stylesheet_uri(), array(), '1.2.7');
            ...
            wp_enqueue_style('bootstrap-basic4-main', get_template_directory_uri() . '/assets/css/main.css', array(), '1.2.7');
            ...
            wp_enqueue_script('bootstrap-basic4-main', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), '1.2.7', true);
